...
public class TesteMainframe {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String strProgram = "AJX1001P";

			// Servidor CICS onde faremos a conexao.
			String strChosenServer = "CICSEPP1";

			// Endereco IP do servidor CICS.
			String strUrl = "200.142.195.214";
	...
	private static boolean validaRetorno(ECIRequest requestObject) {
		...
		try {
			...
			/* Verifica se foi gerado um erro onde o usuário esta autorizado
			...
			case ECIRequest.ECI_ERR_TRANSACTION_ABEND:
				System.out.println("\nVocê não esta autorizado a executar esta transação.");
			}
